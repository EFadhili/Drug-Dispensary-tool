  ...
  <div class="container">
    <nav>
      <div class="side_navbar">
        <span>Main Menu</span>
        <a href="phamdash.php">Dashboard</a>
        <a href="#">Profile</a>
    ...
    <div class="main-body">
      ...
      <div class="promo_card">
        <h1>Phamacist's History Page</h1>
        <span>View all patients ever dispended drugs.</span>       
      </div>

      <div class="history_lists">
        <div class="list1">
          <div class="row">
            <h4>Dispensed Patients</h4>
            <a href="#">See all</a>
          </div>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    if ($row["appointment_id"] !== $previousAppointmentId) {
                        ...
                        echo "<td><a href='done_dispense.php?appointment_id=" . $row["appointment_id"] . "'>" . $row["first_name"] . "</a></td>";
